    ...
    <el-dialog :title="title" v-model="open" width="800px" append-to-body @opened="modalOpened" @close="closeDialog">
      ...
      <el-row>
        ...
        <el-col :lg="{ span: 2, offset: 6 }" :md="2">
          <el-button type="primary" @click="uploadImg()">Save</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
...
export default {
  ...
  setup() {
    ...
    const options = reactive({
      img: 'https://t4.ftcdn.net/jpg/05/42/36/11/360_F_542361185_VFRJWpR2FH5OiAEVveWO7oZnfSccZfD3.jpg', //useStore.avatar, // 裁剪图片的地址
    ...
    function beforeUpload(file) {
      if (file.type.indexOf('image/') == -1) {
        proxy.$modal.msgError('The file format is incorrect. Please upload an image of the same type, such as a file with a JPG or PNG suffix.')
      } else {
