<template>
  <el-drawer v-model="showSettings" :withHeader="false" direction="rtl" size="300px">
    ...
    <div class="setting-drawer-block-checbox">
      ...
      <div class="item" @click="handleTheme('theme-primary')">
        <img src="@/assets/images/dark.svg" alt="dark" />
        <div v-if="sideTheme === 'theme-primary'" class="setting-drawer-block-checbox-selectIcon" style="display: block">
          <el-icon><Check /></el-icon>
        </div>
      </div>
...
function handleTheme(val) {
  ...
  else if (val == 'theme-primary') body.setAttribute('data-theme', 'theme-primary')
