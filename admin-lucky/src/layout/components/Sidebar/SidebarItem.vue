      ...
      <app-link v-if="onlyOneChild.meta" :to="resolvePath(onlyOneChild.path, onlyOneChild.query)">
        <el-menu-item :index="resolvePath(onlyOneChild.path)">
          ...
          <template v-if="onlyOneChild.meta.titleKey" #title>
            <span style="font-size: var(--el-font-size-base)"> {{ $t(onlyOneChild.meta.titleKey) }} </span>
          </template>
          <template v-else-if="onlyOneChild.meta.title" #title> {{ onlyOneChild.meta.title }} </template>
        </el-menu-item>
      </app-link>
    </template>
